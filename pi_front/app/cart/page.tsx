...
import { Address } from "../register/schema";
...
export default function Cart() {
  ...
  const [fretesDisponiveis, setFretesDisponiveis] = useState<Frete[]>([]);
            ...
            <div className="mt-8">
              ...
              <form>
                ...
                <button
                  ...
                  className={`mb-5 w-full text-center bg-black rounded-xl py-3 px-6 font-semibold text-lg text-white ${cart.length === 0 || !freteSelecionado
                    ? "cursor-not-allowed"
